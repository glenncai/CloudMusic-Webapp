...
class Constants {
    ...
    public static $passwordNotValid = "Your password must be between 8 and 25 characters, <br> must contain at least 1 number and 1 letter, and may contain any of these characters: !.@#$%";
